...
function [all_score,all_prediction] = classification(D, W, data, dictlabel , sparsity)
...
for featureid=1:size(data,2)
 ...
 %   end
    all_score = [all_score maxv_est] ;
    all_prediction = [all_prediction dictlabel(maxind_est)]  ;
end

...
noiseimageName = 'noisebarbara160.png';
[IMin,pp]=imread(strcat([pathForImages,noiseimageName]));
IMin=im2double(IMin);
...
%{
IMin0 = imresize(IMin0,[160,160]); 



IMin=IMin0  + sigma*randn(size(IMin0));
IMin = uint8(IMin); 
imwrite(IMin,'noisebarbara160.png'); 
%}
